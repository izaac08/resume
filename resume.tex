...
\vspace{0.15cm}
\text{ 905-341-0341 \hspace{3.5cm} imlaundr@uwaterloo.ca \hspace{3.5cm} \href{www.linkedin.com/in/izaac-mottiar}{LinkedIn}}
\end{center}
\end{tcolorbox}
...
\begin{description}
    \vspace{-0.5cm}
     \item[\hspace{0.5cm}Programming:] Fluent in Python, C/C++, MATLAB, MS Excel, Ladder Logic, React and CSS.
    \vspace{-0.2cm}
